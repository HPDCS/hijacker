...
/**
 * Seeks the function descriptor associated with a given function symbol
 * descriptor.
 *
 * @param sym Pointer to the function symbol descriptor.
 *
 * @return Pointer to the function descriptor found, if any, or <em>NULL</em>.
 *
 * @author Simone Economo
 */
function *find_func_from_sym(symbol *sym) {
	function *func;
